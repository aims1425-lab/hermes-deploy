...
- ✅ Added [docs/CODEX_FOR_OSS_APPLICATION.md](docs/CODEX_FOR_OSS_APPLICATION.md) with a truthful maintainer-support application draft.
- ✅ Added [docs/OPENAI_FORM_ANSWERS.md](docs/OPENAI_FORM_ANSWERS.md) with ready-to-copy short form answers under 500 characters.
